package com.example.databasemysql.domain.post.bulkInsert;
...
import com.example.databasemysql.util.PostFixtureFactory;
...
@ComponentScan({"com.example.databasemysql.domain.post"})
