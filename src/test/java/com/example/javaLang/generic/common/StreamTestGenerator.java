...
public class StreamTestGenerator {
    ...
    public static Student ahphabetFirstPerson = new Student("김유신",28, 89);

    public static final Supplier<Stream<Student>> testPeopleSupplier = () -> Stream.of(youngestPerson, intermediatePerson, lowestScorePerson, ahphabetFirstPerson);
